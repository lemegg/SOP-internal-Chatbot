...
class Settings(BaseSettings):
    ...
    ANALYTICS_ALLOWED_EMAILS: str = "worshipgate1@gmail.com,sruthi@theaffordableorganicstore.com,anurag@theaffordableorganicstore.com,shivam@theaffordableorganicstore.com"
